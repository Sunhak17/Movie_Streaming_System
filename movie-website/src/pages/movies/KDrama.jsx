...
import '../../styles/movies/kdrama.css';
...
const KDrama = () => {
    ...
    // Fetch K-Drama movies from database
    useEffect(() => {
        const fetchMovies = async () => {
            try {
                setLoading(true);
                const response = await apiService.getMoviesByCategory('kdrama');
                ...
                console.error('Error fetching K-Drama movies:', err);
            } finally {
                setLoading(false);
            }
        };
        ...
        return (
            <>
                ...
                <div className="no-movies-container" style={{ padding: '100px', textAlign: 'center' }}>
                    <h2>No K-Drama movies available</h2>
                </div>
                <Footer />
            </>
        );
                                ...
                                <div className="hero-content">
                                    ...
                                    <div className="hero-buttons">
                                        <button 
                                            ...
                                            onClick={() => window.open("https://res.cloudinary.com/dfx39eneo/video/upload/v1754395312/CJ_-_WHOOPTY_ERS_Remix_Baby_Driver_ff2u58.mp4", "_blank")}                                        >
                                            ▶ Watch Now
                                        </button>
